...
class UserLoginForm(forms.Form):
    ...
    def clean(self, *args, **kwargs):
        ...
        if email and password:
            ...
            if not qs.exists(): # если юзера нет
...
class UserRegistrationForm(forms.ModelForm):
    email = forms.EmailField(label='Введите имэйл', # емаил взят из модели юзера и он уже уникальный
    ...
    class Meta:
        model = User
        fields = ('email',)# password по умолчанию
...
class UserUpdateForm(forms.Form):
    #какой город какой язык програмирваия и хочет ли получать рассылку
